...
import es.nicolas.rest.auth.exceptions.AuthDifferentPasswords;
import es.nicolas.rest.auth.exceptions.AuthExistingUsernameOrEmail;
import es.nicolas.rest.auth.exceptions.AuthSignInNotValid;
